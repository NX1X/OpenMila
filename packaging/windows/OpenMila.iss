...
; uninstalls after a crash should still be able to send them.
...
begin
  ...
  Result := SuppressibleMsgBox('Also delete your OpenMila data?' + #13#10#13#10 +
      'This permanently deletes your recordings, transcripts, downloaded models and app data from' + #13#10 +
